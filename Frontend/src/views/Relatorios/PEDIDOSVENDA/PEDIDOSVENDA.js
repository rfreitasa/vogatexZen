...
function PEDIDOSVENDA() {
  ...
  const [id_ERPSupervisor, setIdERPSupervisor] = useState('');
  ...
  const handleSearch = async data => {
    try {
      ...
      data.supervisorId = id_ERPSupervisor;
      }
      ...
      if (statusPedidos.length > 0) {
        ...
        data.status = status_selecionados;
      }
      if (state.length > 0) {
      ...
      var axios_search = `${API.relatorios}/?relatorio=PEDIDOSVENDA&email=${email}`;
      const parametros = {
    ...
    return (
      <>
        <Grid container spacing={1}>
          ...
          <Grid key="supervisor" item xs={6} sm={12} lg={5}>
            <div className="input">
              ...
              <Autocomplete
                ...
                getItemValue={item => {
                  ...
                  setIdERPSupervisor(item ? item.USUARIO_CONTA_ID_ERP : ''); 
          ...
          <Grid key="Agrupamento" item xs={12} sm={12} lg={4}>
            <div className="input">
              ...
              <select name="group1" ref={register}>
                ...
                <option value="personGroup_description">
                  Grupo empresarial
                </option>
                ...
                <option value="sale_date">Emissão</option>
                <option value="sale_availabilityDate">Previsão</option>
              </select>
            </div>
          </Grid>
  ...
  style={{
    ...
    alignItems: 'center',
    justifyContent: 'center',
    gap: '8px', // Espaço entre o spinner e o texto
    minWidth: '120px'
  }}
>
  {isLoading ? (
...
export default connect()(PEDIDOSVENDA);
