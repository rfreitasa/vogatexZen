  ...
  const handleSearch = async data => {
    try {
      ...
      if (data.dataini === '' || data.datafim === '') {
        ...
        const verificaEAtualizaArray = array => {
          if (Array.isArray(array) && array.length > 0) {
            return encodeURIComponent(
              JSON.stringify(array.map(item => item.value)),
            );
          } else {
            return null;
          }
        ...
        axios_search = `${API.relatorios}/?relatorio=EIR6000COM&email=${email}&${where}`;
                    ...
                    <Grid item xs={12} sm={12} lg={5}>
                      <div className="input">
                        ...
                        <select name="dados" ref={register}>
                          ...
                          <option value="city_name">Cidade</option>
                          <option value="state_name">Estado</option>
                          ...
                          <option value="product_category_description_1">
                            Classe
                          </option>
                        </select>
                      </div>
                    ...
                    <Grid item xs={12} sm={12} lg={5}>
                      <div className="input">
                        ...
                        <select name="agrupamento" ref={register}>
                          ...
                          <option value="state_code">Estado</option>
                          <option value="salesperson_name">Vendedor</option>
                          <option value="product_code">Produto Mestre</option>
                          <option value="productPacking_code">
                            Produto filho
                    ...
                    <Grid item xs={12} sm={12} lg={2}>
                      <div className="input">
                        ...
                        <select name="ordenacao" ref={register}>
                          ...
                          <option value="invoiceItem_totalValue" selected>
                            Valor
                          </option>
                        </select>
                      </div>
                      ...
                      <div className="input">
                        ...
                        <Select
                          ...
                          onChange={value => {
                            ...
                            if (valor > 1) {
                              setIdVendedorP(value.value ? value.value : '');
                              setVendedorP(value.label ? value.label : '');
                            } else {
                              setIdVendedorP('');
                              setVendedorP('');
                            }
