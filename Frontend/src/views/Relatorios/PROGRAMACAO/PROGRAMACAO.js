...
function PROGRAMACAO() {
  ...
  const handleSearch = async (data) => {
    try {
      ...
      where = where + `&exibe_sem_disponibilidade=${data.exibe_sem_disponibilidade}`

      axios_search = `${API.relatorios}/?relatorio=PROGRAMACAO&email=${email}${where}`;
            ...
            <Typography component={"div"}>
              <Form>
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={12} lg={12}>
                      <div className="input">
                        <label>Exibir produtos sem disponibilidade?</label>
                        <select name="exibe_sem_disponibilidade" ref={register}>
...
export default connect()(PROGRAMACAO);
